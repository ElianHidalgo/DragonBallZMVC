...
namespace DragonBallZMVC.Controllers
{
    public class TecnicasController : Controller
    {
        ...
        {
            return View(db.Tecnicas.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "TecnicaId,NombreTecnica,Tipo,NivelDano")] Tecnica tecnica)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TecnicaId,NombreTecnica,Tipo,NivelDano")] Tecnica tecnica)
        {
            if (ModelState.IsValid)
            {
